...
export default function HomePage() {
  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-ink-950 pt-16">
      <div className="pointer-events-none absolute inset-0 bg-dotgrid opacity-20" />
      <div className="pointer-events-none absolute -top-40 left-1/2 -z-10 h-[820px] w-[1100px] -translate-x-1/2 rounded-full bg-[radial-gradient(circle_at_center,rgba(34,212,164,0.10),transparent_60%)] blur-3xl" />

      {/* Console header */}
      <header className="relative z-10 border-b border-white/5 bg-ink-950/40 backdrop-blur">
        <div className="mx-auto flex max-w-[1600px] items-center justify-between px-6 py-4 lg:px-10">
          ...
          <div className="flex items-center gap-3 text-[11px]">
            ...
            <div className="flex items-center gap-1.5 rounded-full border border-white/5 bg-white/[0.03] px-2.5 py-1 text-ink-300">
              <span
                className={
      ...
      {/* Body grid */}
      <section className="relative z-10 mx-auto grid max-w-[1600px] grid-cols-12 gap-4 px-6 py-6 lg:px-10">
        {/* Left: form + result */}
        ...
        {/* Centre: map */}
        <div className="col-span-12 h-[calc(100vh-240px)] lg:col-span-6">
          <MapPanel
            selected={{
              lat: selected.lat,
              lon: selected.lon,
        ...
        <aside className="col-span-12 lg:col-span-3">
          <div className="glass h-[calc(100vh-240px)] rounded-2xl p-5">
            <HotspotsPanel
              metadata={metadata}
              hour={hour}
              setHour={setHour}
      ...
      <footer className="relative z-10 border-t border-white/5 px-6 py-3 text-[11px] text-ink-500 lg:px-10">
...
function MetricBadge({ label, value }: { label: string; value: string }) {
  return (
    <div className="flex items-center gap-1 rounded-full border border-white/5 bg-white/[0.03] px-2.5 py-1 text-ink-300">
